...
{
    public partial class FrmHomeScreenForBidCord : System.Web.UI.Page
    {
       ...
       string UserId = string.Empty;
        ...
        {
            //lblCloseNoRecords.Text = string.Empty;
        ...
        protected void TopMangmtClosedOpportunity(string SalesUserId, int DesignationId)
        {
            lblCloseNoRecords.Text = string.Empty;
            //lblOpenNoRecords.Text = string.Empty;
            DataSet TopMangmtClosedOpportunity_details = new BLL.HomeScreensBLL().Get_BCClosedOpportunityDetails(SalesUserId, DesignationId);
            ...
            if (count == 0)
            {
                lblCloseNoRecords.Text = "No Records Found!!!";
            }
            else
            {
                for (int i = 0; i <= count - 1; i++)
